...
class _DashboardDokterState extends State<DashboardDokter>
  ...
  void setStatus(String status) async {
    print("setStatus no ktp dokter : " + controllerDokter.dokter.value.noKtp);
    var data = await _firestore
        .collection("users")
        .doc(controllerDokter.dokter.value.noKtp)
            ...
            child: Column(
              children: <Widget>[
                    ...
                    Positioned(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: AssetImage(
                              'assets/images/wave_Dashboard_Dokter.png'),
                          fit: BoxFit.fill,
                        )),
                        child: Stack(
                          children: <Widget>[
                ...
                Container(
                  ...
                  padding:
                      EdgeInsets.only(top: 5, bottom: 5, left: 5, right: 25),
                  decoration: BoxDecoration(
                    color: Colors.white,
                ...
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: controllerHomeDoctor
                        .chatsStream(controllerChat.user.value.nik),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return StreamBuilder<DocumentSnapshot>(
                              stream: controllerHomeDoctor.friendStream(
